...
from packrelic.config.cli_settings import DEFAULT_CLI_LANG

CORE_TEXTS = {
    "en": {
        "description": "PackRelic command line interface.",
        "usage": "pkrc [-h] <command> [command options] [paths...]",
        ...
        "write_manifest": "Write internal extraction_manifest.json files under output .packrelic directories.",
    ...
    "zh": {
        ...
        "write_manifest": "在输出目录的 .packrelic 中写入内部 extraction_manifest.json 文件。",
